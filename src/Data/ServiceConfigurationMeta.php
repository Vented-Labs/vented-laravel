...
final readonly class ServiceConfigurationMeta
{
    /**
    ...
    public function __construct(
        ...
        public ServiceConfigurationMetaFormOptions $form_options,
    ) {}
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            form_options: ServiceConfigurationMetaFormOptions::fromArray(self::objectValue($data['form_options'])),
        );
    }
